package com.xueqiu.streaming.batch.task.core.context;



import com.xueqiu.streaming.batch.task.core.AbstractBatchTask;
import com.xueqiu.streaming.batch.task.core.TaskAttributeAccessor;
import com.xueqiu.streaming.batch.task.core.TaskLifecycle;
import com.xueqiu.streaming.batch.task.core.bo.TaskResultInfo;
import com.xueqiu.streaming.batch.task.core.bo.TaskWrapper;
...
public class TaskManageContainer implements TaskAttributeAccessor<TaskWrapper>, TaskLifecycle {
     ...
     * <p>设置任务到该容器中{@link #setTaskWrapper(String, com.xueqiu.streaming.batch.task.core.bo.TaskWrapper)}  setTaskWrapper}
